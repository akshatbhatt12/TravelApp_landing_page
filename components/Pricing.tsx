...
const Pricing =()=> {
  ...
  <h1 className="text-5xl font-bold mt-6 mb-6 text-center">Pricing & Subscription</h1>
  <div className="flex flex-col lg:flex-row justify-center gap-6">
    <div className="max-w-lg w-full bg-white shadow-md rounded-lg overflow-hidden mb-6 lg:mb-0">
      ...
      <ul className="text-lg text-gray-600 px-6">
